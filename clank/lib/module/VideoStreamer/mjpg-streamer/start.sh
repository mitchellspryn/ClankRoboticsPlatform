...
/root/robot/clank/lib/module/VideoStreamer/mjpg-streamer/mjpg_streamer -i "/root/robot/clank/lib/module/VideoStreamer/mjpg-streamer/input_uvc.so -d /dev/video3" -o "/root/robot/clank/lib/module/VideoStreamer/mjpg-streamer/output_http.so -w /root/robot/clank/lib/module/VideoStreamer/mjpg-streamer/www"
